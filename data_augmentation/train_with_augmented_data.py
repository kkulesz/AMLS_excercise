...
from torchvision.transforms import RandomHorizontalFlip, RandomVerticalFlip, RandomRotation, RandomCrop, GaussianBlur
...
def main():
    ...
    # transform = RandomCrop(5, pad_if_needed=True)
